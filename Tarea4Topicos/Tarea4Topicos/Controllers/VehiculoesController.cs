...
namespace Tarea4Topicos.Controllers
{
    public class VehiculoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VehiculoId,Placa,Anio")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehiculoId,Placa,Anio")] Vehiculo vehiculo)
        {
